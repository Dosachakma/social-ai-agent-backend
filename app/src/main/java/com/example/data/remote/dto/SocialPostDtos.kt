...
data class SocialPostDto(
    ...
    @Json(name = "target_platforms") val targetPlatforms: List<String>? = emptyList(),
    ...
    @Json(name = "require_approval") val requireApproval: Boolean? = true,
    ...
    @Json(name = "is_ai_generated") val isAiGenerated: Boolean? = true,
    @Json(name = "error_message") val errorMessage: String? = null,
    @Json(name = "retry_count") val retryCount: Int? = 0,
    @Json(name = "max_retries") val maxRetries: Int? = 3,
    @Json(name = "engagement_score") val engagementScore: Int? = null,
    @Json(name = "engagement_count") val engagementCount: Int? = null,
    @Json(name = "publish_results") val publishResults: List<PlatformPublishResultDto>? = null,
...
data class CreateSocialPostRequest(
    ...
    @Json(name = "targetPlatforms") val targetPlatforms: List<String>,
    @Json(name = "status") val status: String? = "DRAFT",
    @Json(name = "approvalState") val approvalState: String? = "PROPOSED",
    @Json(name = "scheduledAt") val scheduledAt: String? = null,
    @Json(name = "timezone") val timezone: String? = "America/New_York",
    @Json(name = "repeatOption") val repeatOption: String? = "NONE",
    @Json(name = "requireApproval") val requireApproval: Boolean? = true,
    @Json(name = "mediaUrls") val mediaUrls: List<String>? = null,
    @Json(name = "hashtags") val hashtags: String? = null,
    @Json(name = "cta") val cta: String? = null,
    @Json(name = "isAiGenerated") val isAiGenerated: Boolean? = true
)

@JsonClass(generateAdapter = true)
data class UpdateSocialPostRequest(
    @Json(name = "title") val title: String? = null,
    @Json(name = "content") val content: String? = null,
